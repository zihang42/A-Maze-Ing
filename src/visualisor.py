...
class MazeVisualizer:
    ...
    def __init__(
        ...
        self.m.mlx_key_hook(self.win_ptr, handle_key, self)
        self.m.mlx_expose_hook(self.win_ptr, handle_expose, self)
        self.m.mlx_hook(self.win_ptr, 33, 0, handle_close, self)
    ...
    def generate_maze_image(self) -> None:
        ...
        self.draw(
            self.entry[1] * CELL_SIZE + 3,
            self.entry[0] * CELL_SIZE + 3,
            CELL_SIZE - 3,
            CELL_SIZE - 3,
            COLOR_ENTRY,
        )
        self.draw(
            self.exit[1] * CELL_SIZE + 3,
            self.exit[0] * CELL_SIZE + 3,
            CELL_SIZE - 3,
            CELL_SIZE - 3,
            COLOR_EXIT,
        )
